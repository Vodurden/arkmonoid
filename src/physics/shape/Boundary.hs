...
collision :: Boundary -> CollisionModel -> Maybe Collision
...
staticCollision :: Boundary -> CollisionModel -> Maybe Collision
...
dynamicCollision :: Boundary -> CollisionModel -> Maybe Collision
