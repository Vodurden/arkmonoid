...
module Physics.CollisionDetection.Detection where

import Physics.Types
import Physics.CollisionDetection.Types
import qualified Physics.CollisionDetection.BoundaryCollision as BoundaryCollision
import qualified Physics.CollisionDetection.ExistingCollision as ExistingCollision
import qualified Physics.CollisionDetection.ImpendingCollision as ImpendingCollision

import qualified Data.Map.Strict as Map
import Data.Maybe (maybeToList)
import Control.Lens
import Extra.List (pairs)
import Extra.Ord (minBy)
