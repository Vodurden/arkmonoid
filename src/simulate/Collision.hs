...
-- data Collision = EntityCollision Ent S.ShapeCollision
--                | BoundaryCollision Ent S.PenetrationVector
...
--   fmap (uncurry (CurrentEntityCollision ent1 ent2)) (shapeImpact shape1 shape2)
